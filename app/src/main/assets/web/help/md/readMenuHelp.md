...
* 长按背景可进入文字颜色和背景设置界面
* 本版本默认选中“文字”预设，字号 34、字距 0.07、行距 0.7、段距 1.1，翻页动画为滚动
* 默认阅读字体为内置字体；如果手动更换字体，可在字体选择中重新选择
* 默认边距为页眉上/下/左/右 24/12/24/24，正文 12/12/20/20，页脚 12/12/24/24，页眉和页脚分隔线默认关闭
...
* 点击区域设置
* 自定义翻页按键
* 本版本默认隐藏状态栏、隐藏导航栏、扩展到刘海，填充刘海区域默认关闭
