...
- [下载阅读·B 版](https://github.com/xiaoxin0819/legado/releases/latest/download/legado_app_3.26.070702_readingB.apk)
- [下载 Debug 版](https://github.com/xiaoxin0819/legado/releases/latest/download/legado_app_3.26.070702_debug.apk)
...
```text
D:\codexproject\yuedu\legado_app_3.26.070702_readingB.apk
D:\codexproject\yuedu\legado_app_3.26.070702_debug.apk
```

如果设备上已经安装同一签名的调试版，可以直接覆盖安装。

```powershell
adb install -r D:\codexproject\yuedu\legado_app_3.26.070702_debug.apk
adb install -r D:\codexproject\yuedu\legado_app_3.26.070702_readingB.apk
```
